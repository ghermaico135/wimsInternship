...
<div class="page-title">
    <div class="title_left">
        <h4 style="color: orange">UPDATE PROJECT PROGRESS</h4>
    </div>
...
?>
    ...
    <form method="post" action="<?php _link(); ?>updateProject_" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
      ...
      ?>
        ...
        <tr>
            <td>
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Project Progress">Project Progress <span class="required">:</span>
                    </label>
                    <div class="col-md-7 col-sm-9 col-xs-12">
                        <select name="status[]" value="<?php echo $row['status']?>" class="form-control col-md-7 col-xs-12" required="required">
                            <option value="Submitted">Submitted</option>
                            <option value="Approved">Approved</option>
                            <option value="Finished Waiting Presentation">Finished Awaiting Presentation</option>
...
?>
   ...
   <center><button class="btn btn-info" type="submit" name="savemul"><i class="glyphicon glyphicon-pencil"></i>&nbsp; Update-Progress</button>&nbsp;&nbsp;

...
<div class="page-title">
    <div class="title_left">
        <h4 style="color: orange">EDIT THE SELECTED TASK</h4>
    </div>
...
?>
    ...
    <form method="post" action="<?php _link(); ?>updateTask" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
       ...
       <tr>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <input type="hidden" name="task_id" value="<?php echo $row['task_id'];?>"  class="form-control col-md-7 col-xs-12">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <input type="text" name="task_name[]" value="<?php echo $row['task_name'];?>"  class="form-control col-md-7 col-xs-12" required="required" readonly="readonly">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-9 col-xs-12">
                        <textarea name="task_description[]" value="<?php echo $row['task_description'];?>" required="required" class="form-control col-md-7 col-xs-12" rols="5"></textarea>
                    </div>
                </div>

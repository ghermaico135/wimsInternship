 ...
 */
var URL_SPLIT = window.location.href.split('#')[0].split('?'),
    CURRENT_URL = URL_SPLIT[0],
    $BODY = $('body'),
...
function init_sidebar() {
    ...
    // check active menu
    /*$SIDEBAR_MENU.find('a[href="' + CURRENT_URL +'?'+ URL_SPLIT[1] + '"]').parent('li').addClass('current-page');*/
    
    /* EDITED */ console.log('index.php?'+ URL_SPLIT[1]);
    $SIDEBAR_MENU.find('a').parent('li').removeClass('current-page');
    $SIDEBAR_MENU.find('a[href="' + 'index.php?'+ URL_SPLIT[1] + '"]').parent('li').addClass('current-page');
    /* EDITED */
